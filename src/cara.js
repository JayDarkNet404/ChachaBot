const cara = (pushname, prefix, botName, ownerName) => { 
	return `🔰 -----[ *PANDUAN PENGGUNAAN ${ChachaBot}* ]----- 🔰
Hallo, ${pushname} 👋
Berikut adalah cara penggunaan *${ChachaBot}*
         ────────────────
...
➸ *${prefix}ttp*
Text to sticker contoh : ${prefix}ttp JayDarkNet
➸ *${prefix}tts*
Suara google contoh : ${prefix}tts id Hallo JayDarkNet
➸ *${prefix}toimg*
...
➸ *${prefix}pornhub*
Membuat logo, contoh : ${prefix}pornhub JayDarkNet & Hub
