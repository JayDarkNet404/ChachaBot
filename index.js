/*
]=====> JayDarkNet OFFICIAL <=====[ ]=====> YT JayDarkNet CHANNEL <=====[ ]=====> 08993801551 <=====[
*/
const {
   WAConnection,
   MessageType,
...
*/				
            	case 'mining':
                      ...
                      reply(`karena Jay baik Bot memberikan ${one}Xp >_<`)
                      }else{
